              ...
              <div className="">
                ...
                <form method="PATCH" id="edit-profile-form">
                  ...
                  <div className="">
                    ...
                    <div className="cursor-pointer flex justify-start ml-2 md:ml-4 mt-16 w-32 h-32 md:h-36 md:w-36 rounded-full absolute group">
                  ...
                  {/* Text Edits */}
                  <div className="mt-52 h-64 overflow-y-auto p-2">
                    <div className="">
                      <label htmlFor="firstName" className="pl-2 text-sm text-stone-500">First Name</label>
                      <input id="firstName" name="firstName" className="border-2 border-stone-200 rounded p-2 w-full justify-center" placeholder="Enter your first name." value={data.firstName} type="text"></input>
                    </div>
                    <div className="mt-2">
                      <label htmlFor="lastName" className="pl-2 text-sm text-stone-500">Last Name</label>
                      <input id="lastName" name="lastName" className="border-2 border-stone-200 rounded p-2 w-full justify-center" placeholder="Enter your last name." value={data.lastName} type="text"></input>
                    </div>
                    <div className="mt-2">
                      <label htmlFor="bio" className="pl-2 text-sm text-stone-500">Bio</label><br></br>
                      <textarea className="border-2 border-stone-200 rounded p-2 w-full justify-center" name="bio" id="bio" rows={5} placeholder="Write something about yourself." value={data.bio}></textarea>
                    </div>
                    <div className="mt-1">
                      <label htmlFor="location" className="pl-2 text-sm text-stone-500">Location</label>
                      <input id="location" name="location" className="border-2 border-stone-200 rounded p-2 w-full justify-center" placeholder="Enter your location." value={data.location} type="text"></input>
                    </div>
                    <div className="mt-2">
